...
export default function Loading() {
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#09090b] text-zinc-400 select-none">
      ...
      <div className="w-full max-w-sm flex flex-col items-center space-y-6 px-6">

        {/* Transit Stage */}
        <div className="relative w-full h-16 overflow-hidden flex flex-col justify-end">

          {/* Animated Moving Bus SVG */}
          <div className="animate-bus absolute bottom-2 left-0 text-[#FF6B35] group">
