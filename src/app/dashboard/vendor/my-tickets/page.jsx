...
const MyAddedTickets = async () => {
  ...
  return (
    // 🌍 গ্লোবাল ব্র্যান্ড ব্যাকগ্রাউন্ড কন্ট্রোল (Light: #F8FAFC, Dark: #0F172A)
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0F172A] text-[#1E293B] dark:text-[#E2E8F0] transition-colors duration-300 text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-8">
        ...
        <div className="relative overflow-hidden bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/60 p-6 md:p-8 rounded-3xl shadow-xl shadow-slate-200/30 dark:shadow-none flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="space-y-2 relative z-10">
            ...
            <h2 className="text-2xl md:text-3xl font-black tracking-tight text-[#1E293B] dark:text-white">
              My Added Tickets
            </h2>
          ...
          {/* ⚡ High-Tech Micro Capsule Indicator Badge */}
          <div className="inline-flex items-center gap-2 bg-[#FF6B35]/5 dark:bg-[#FF6B35]/10 border border-[#FF6B35]/20 dark:border-[#FF6B35]/30 rounded-2xl px-4 py-2.5 self-start sm:self-center shadow-xs">
